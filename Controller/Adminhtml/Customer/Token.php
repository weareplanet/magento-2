 ...
 */
namespace WeArePlanet\Payment\Controller\Adminhtml\Customer;
...
/**
 * Backend controller action to delete WeArePlanet tokens.
 */
class Token extends \Magento\Customer\Controller\Adminhtml\Index
{
    ...
    public function execute()
    {
        ...
        if ($customerId && $tokenId) {
            try {
                /** @var \WeArePlanet\Payment\Model\TokenInfo $token */
