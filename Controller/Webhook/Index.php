 ...
 */
namespace WeArePlanet\Payment\Controller\Webhook;
...
use WeArePlanet\Payment\Model\Service\WebhookService;
use WeArePlanet\Payment\Model\Webhook\Request;

/**
 * Frontend controller action to proces webhook requests.
 */
class Index extends \WeArePlanet\Payment\Controller\Webhook implements CsrfAwareActionInterface
{
     ...
     * @return \WeArePlanet\Payment\Model\Webhook\Request
     */
