...
use WeArePlanet\Sdk\Service\PaymentMethodConfigurationService;
...
class PaymentMethodConfigurationManagement implements PaymentMethodConfigurationManagementInterface
{
    ...
    {
        $this->configWriter->save('payment/weareplanet_payment_' . $configuration->getEntityId() . '/' . $key,
            $value, $scope, $scopeId);
    }
     ...
     * @return bool
     */
    private function hasConfigurationChanged(\WeArePlanet\Sdk\Model\PaymentMethodConfiguration $configuration,
