...
class SettingsProvider extends DefaultSettingsProvider implements SettingsProviderInterface
{
     ...
     * @var int
     */
    private const XML_PATH_SPACE_ID = 'weareplanet_payment/general/space_id';

    /**
     * @var int
     */
    private const XML_PATH_USER_ID = 'weareplanet_payment/general/api_user_id';

    /**
     * @var string
     */
    private const XML_PATH_API_SECRET = 'weareplanet_payment/general/api_user_secret';

    /**
     * @var string
     */
    private const XML_PATH_LOG_LEVEL = 'weareplanet_payment/logging/log_level';
