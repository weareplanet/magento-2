...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $config['weareplanet']['restoreCartUrl'] =
        $quote->getStore()->getUrl('weareplanet_payment/checkout/restoreCart', [
            '_secure' => true
        ]);
        ...
        if ($integrationMethod == IntegrationMethod::IFRAME) {
            ...
            try {
                $config['weareplanet']['paymentPageUrl'] = $quote->getStore()->getUrl(
