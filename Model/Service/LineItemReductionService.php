...
use WeArePlanet\Sdk\Model\LineItemReductionCreate;
...
class LineItemReductionService
{
    ...
    {
        /** @var \WeArePlanet\Sdk\Model\LineItem[] $baseLineItems */
        $baseLineItems = $this->getBaseLineItems($creditmemo->getOrder()
            ->getWeareplanetSpaceId(), $creditmemo->getOrder()
        ...
        $this->eventManager->dispatch('weareplanet_payment_convert_line_item_reductions',
            [
                'transport' => $transport,
     ...
     * @param Creditmemo $creditmemo
     * @param \WeArePlanet\Sdk\Model\LineItem[] $baseLineItems
     * @return void
     * @throws LineItemReductionException
     */
