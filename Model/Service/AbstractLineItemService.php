...
abstract class AbstractLineItemService
{
    ...
    protected function convertLineItems($entity)
    {
        ...
        $this->eventManager->dispatch(
            'weareplanet_payment_convert_line_items',
            [
                'transport' => $transport,
                'entity' => $entity
            ]
    ...
    private function convertItem($entityItem, $entity)
    {
        ...
        $this->eventManager->dispatch(
            'weareplanet_payment_convert_product_line_item',
            [
                'transport' => $transport,
    ...
    protected function getCustomAttributes($productId, $storeId)
    {
        ...
        $productAttributeCodeConfig = $this->scopeConfig->getValue(
            'weareplanet_payment/line_items/product_attributes',
    ...
    protected function convertShippingLineItemInner(
        ...
        if ($shippingAmount > 0) {
            ...
            if ($this->scopeConfig->getValue(
                'weareplanet_payment/line_items/overwrite_shipping_description',
                ScopeInterface::SCOPE_STORE,
                $entity->getStoreId()
            )
            ) {
            ...
            $this->eventManager->dispatch(
                'weareplanet_payment_convert_shipping_line_item',
                [
                    'transport' => $transport,
                    'entity' => $entity
                ]
