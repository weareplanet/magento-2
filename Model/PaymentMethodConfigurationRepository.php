...
use WeArePlanet\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterfaceFactory;
use WeArePlanet\Payment\Model\ResourceModel\PaymentMethodConfiguration as PaymentMethodConfigurationResource;
use WeArePlanet\Payment\Model\ResourceModel\PaymentMethodConfiguration\CollectionFactory as PaymentMethodConfigurationCollectionFactory;
...
class PaymentMethodConfigurationRepository implements PaymentMethodConfigurationRepositoryInterface
{
    ...
    {
        /** @var \WeArePlanet\Payment\Model\ResourceModel\PaymentMethodConfiguration\Collection $collection */
        $collection = $this->paymentMethodConfigurationCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \WeArePlanet\Payment\Api\Data\PaymentMethodConfigurationSearchResultsInterface $searchResults */
