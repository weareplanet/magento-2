...
use WeArePlanet\Payment\Api\Data\RefundJobSearchResultsInterfaceFactory;
use WeArePlanet\Payment\Model\ResourceModel\RefundJob as RefundJobResource;
use WeArePlanet\Payment\Model\ResourceModel\RefundJob\CollectionFactory as RefundJobCollectionFactory;
...
class RefundJobRepository implements RefundJobRepositoryInterface
{
    ...
    {
        /** @var \WeArePlanet\Payment\Model\ResourceModel\RefundJob\Collection $collection */
        $collection = $this->refundJobCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \WeArePlanet\Payment\Api\Data\RefundJobSearchResultsInterface $searchResults */
