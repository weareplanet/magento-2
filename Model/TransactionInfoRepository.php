...
use WeArePlanet\Payment\Api\Data\TransactionInfoSearchResultsInterfaceFactory;
use WeArePlanet\Payment\Model\ResourceModel\TransactionInfo as TransactionInfoResource;
use WeArePlanet\Payment\Model\ResourceModel\TransactionInfo\CollectionFactory as TransactionInfoCollectionFactory;
...
class TransactionInfoRepository implements TransactionInfoRepositoryInterface
{
    ...
    {
        /** @var \WeArePlanet\Payment\Model\ResourceModel\TransactionInfo\Collection $collection */
        $collection = $this->transactionInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \WeArePlanet\Payment\Api\Data\TransactionInfoSearchResultsInterface $searchResults */
