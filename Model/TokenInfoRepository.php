...
use WeArePlanet\Payment\Api\Data\TokenInfoSearchResultsInterfaceFactory;
use WeArePlanet\Payment\Model\ResourceModel\TokenInfo as TokenInfoResource;
use WeArePlanet\Payment\Model\ResourceModel\TokenInfo\CollectionFactory as TokenInfoCollectionFactory;
...
class TokenInfoRepository implements TokenInfoRepositoryInterface
{
    ...
    {
        /** @var \WeArePlanet\Payment\Model\ResourceModel\TokenInfo\Collection $collection */
        $collection = $this->tokenInfoCollectionFactory->create();

        $this->collectionProcessor->process($searchCriteria, $collection);

        /** @var \WeArePlanet\Payment\Api\Data\TokenInfoSearchResultsInterface $searchResults */
