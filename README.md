...
* [Documentation](https://plugin-documentation.weareplanet.com/weareplanet/magento-2/3.0.0-beta-1/docs/en/documentation.html)
...
Please see the [license file](@WeArePlanetRepoPath(LICENSE)) for more information.
