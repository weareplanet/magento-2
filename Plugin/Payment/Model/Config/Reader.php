 ...
 */
namespace WeArePlanet\Payment\Plugin\Payment\Model\Config;
...
/**
 * Interceptor to dynamically extend the payment configuration with the WeArePlanet payment method data.
 */
class Reader
{
    ...
    {
        return 'weareplanet_payment_' . $configuration->getEntityId();
    }
