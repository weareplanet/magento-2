 ...
 */
namespace WeArePlanet\Payment\Plugin\Framework\App\Config\Initial;
...
use WeArePlanet\Payment\Model\Config\DomFactory;

/**
 * Interceptor to dynamically extend the initial configuration with the WeArePlanet payment method data.
 */
class Converter
{
    ...
    private function generateXml(PaymentMethodConfigurationInterface $configuration)
    {
        return \str_replace(
            ...
            [
                'weareplanet_payment_' . $configuration->getEntityId(),
