...
class AddSetupDataStateProcessing implements DataPatchInterface
{
     ...
     *  Also I'm making sure we're setting processing, shipped_weareplanet and  pending_payment as default.
     * @inheritDoc
     */
    public function apply()
    {
        ...
        $tableName = $this->moduleDataSetup->getTable('sales_order_status_state');
        $updateSql = "UPDATE " . $tableName . " SET state = 'shipped_weareplanet', is_default = 1 WHERE status = 'shipped_weareplanet'";
        $this->moduleDataSetup->getConnection()->query($updateSql);
        ...
        $stateToRemove = 'processing_weareplanet';
