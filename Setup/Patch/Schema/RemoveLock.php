...
namespace WeArePlanet\Payment\Setup\Patch\Schema;
...
class RemoveLock implements SchemaPatchInterface
{
    ...
    /**
     * Drops weareplanet_lock column from sales_order table
    ...
    public function apply(): self
    {
        ...
        $setup->getConnection()->dropColumn($table, 'weareplanet_lock');
